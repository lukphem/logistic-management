<x-layouts.app :title="'Print Documents'">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-ink-500">A tracking number opens its waybill. A manifest number prints just that one destination's batch. A trip number prints every manifest on the trip. A TRF-/DEL- reference reprints a transfer confirmation or delivery sheet. A BULK- number prints that bulk upload batch.</p>
    </div>
