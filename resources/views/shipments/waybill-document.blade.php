...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        body { font-family: Arial, Helvetica, sans-serif; color: #111; margin: 0; padding: 0; font-size: 12px; line-height: 1.4; }
        ...
        .doc-title .tracking-number { font-family: 'Courier New', monospace; font-size: 16px; font-weight: bold; margin-top: 4px; }
        ...
        .grid-2 > div { flex: 1; }
        .field-row { display: flex; justify-content: space-between; padding: 3px 0; border-bottom: 1px dotted #ddd; }
        .field-row dt { color: #666; }
        .field-row dd { margin: 0; font-weight: 500; text-align: right; }
        table.billing { width: 100%; border-collapse: collapse; margin-top: 6px; }
        table.billing td { padding: 5px 0; }
        ...
        .declaration { font-size: 10px; color: #444; background: #f7f7f7; border-radius: 6px; padding: 10px 12px; margin-top: 16px; }
        .terms { font-size: 9px; color: #555; margin-top: 16px; white-space: pre-line; }
        ...
        .footer { margin-top: 24px; padding-top: 10px; border-top: 1px solid #ddd; font-size: 9px; color: #999; text-align: center; }
...
<body>
    ...
    @if ($shipment->special_instructions)
        <p style="font-size: 10px; color: #555; margin-top: 6px;"><strong>Special instructions:</strong> {{ $shipment->special_instructions }}</p>
    @endif
    ...
    @if ($shipment->is_cod)
        <p style="font-size: 10px; color: #555; margin-top: 4px;">Cash on delivery: {{ number_format($shipment->cod_amount, 2) }} {{ $settings->currency }} to be collected from the receiver on delivery.</p>
    @endif
