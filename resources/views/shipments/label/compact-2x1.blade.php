...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        body { font-family: 'Arial Narrow', Arial, Helvetica, sans-serif; color: #000; font-size: 8px; line-height: 1.2; }
        ...
        .piece-tag { font-size: 7px; font-weight: bold; text-align: center; border-bottom: 1px solid #000; margin-bottom: 2px; }
        .barcode-zone { text-align: center; line-height: 1; }
        .barcode-zone svg { max-width: 100%; height: auto; max-height: 0.28in; }
        ...
        .receiver-name { font-weight: bold; font-size: 10px; border-top: 1px dashed #999; padding-top: 1px; overflow-wrap: break-word; }
