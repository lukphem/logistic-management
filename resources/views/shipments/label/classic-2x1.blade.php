...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .page { width: 1.9in; padding: 0.04in; page-break-after: always; }
        .page:last-child { page-break-after: auto; }

        .fit-content { overflow-wrap: break-word; }

        .piece-tag { font-size: 7px; font-weight: bold; text-align: center; background: #000; color: #fff; padding: 1px 0; margin-bottom: 2px; }
        .barcode-zone { text-align: center; line-height: 1; }
        .barcode-zone svg { max-width: 100%; height: auto; max-height: 0.32in; }
        .tracking-number { text-align: center; font-family: 'Courier New', monospace; font-size: 11px; font-weight: bold; margin: 1px 0; overflow-wrap: break-word; }
...
<body>
    ...
    <script>
        // Same guarantee as the 4×6 template, tuned for a much
        // smaller physical page and a lower size floor, since a
        // 2×1 label genuinely has far less room to begin with.
        (function () {
