                ...
                @forelse ($states as $state)
                    <tr class="border-b border-line last:border-0 odd:bg-surface-0 even:bg-surface-50/50 hover:bg-[var(--brand-primary)]/5 transition-colors">
                        ...
                        <td class="px-5 py-3 text-right">
                            ...
                            <form method="POST" action="{{ route('states.destroy', $state) }}" class="inline" data-confirm="Remove this state/province? Its cities will simply become unassigned, not deleted.">
                                @csrf @method('DELETE')
