<x-layouts.app :title="'States / Provinces'">
    ...
    <div class="mb-5 flex items-center justify-between">
        <p class="text-sm text-ink-500">Each state/province belongs to one country.</p>
    ...
    <div class="overflow-hidden rounded-xl border border-line bg-surface-0 shadow-sm">
        <table class="w-full text-left text-sm">
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="4" class="px-5 py-8 text-center text-sm text-ink-500">No states/provinces configured yet.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
