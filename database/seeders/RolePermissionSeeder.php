...
class RolePermissionSeeder extends Seeder
{
     ...
     */
    private array $modules = ['shipments', 'rates', 'riders', 'reports', 'settings', 'roles', 'locations', 'billing', 'users', 'clients'];
    private array $actions = ['create', 'read', 'update', 'delete'];

    private array $defaultRoles = [
        'Super Admin' => '*', // gets every permission
        'Ops Manager' => ['shipments', 'riders', 'reports', 'locations:read', 'rates:read', 'clients'],
        'Hub Staff' => ['shipments:read', 'shipments:update', 'locations:read'],
        'Finance' => ['reports:read', 'settings:read', 'rates', 'billing', 'clients'],
