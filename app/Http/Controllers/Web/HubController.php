...
class HubController extends Controller
{
    ...
    {
        $hubs = Hub::with('region')->withCount('zones')->orderBy('name')->paginate(15);
    ...
    {
        return view('hubs.form', ['hub' => new Hub(), 'regions' => Region::orderBy('name')->get()]);
    }
    ...
    {
        return view('hubs.form', ['hub' => $hub, 'regions' => Region::orderBy('name')->get()]);
    }
